...
const abi = [{"constant":true,"inputs":[{"name":"group","type":"bytes32"},{"name":"index","type":"uint256"}],"name":"getProviderAddress","outputs":[{"name":"","type":"address"}],"payable":false,"type":"function"},{"constant":true,"inputs":[],"name":"syn","outputs":[{"name":"","type":"address"}],"payable":false,"type":"function"},{"constant":true,"inputs":[{"name":"group","type":"bytes32"},{"name":"index","type":"uint256"}],"name":"getProviderRate","outputs":[{"name":"","type":"uint256"}],"payable":false,"type":"function"},{"constant":false,"inputs":[],"name":"withdraw","outputs":[{"name":"","type":"bool"}],"payable":false,"type":"function"},{"constant":false,"inputs":[{"name":"group","type":"bytes32"}],"name":"requestSynapseProvider","outputs":[],"payable":false,"type":"function"},{"constant":false,"inputs":[{"name":"group","type":"bytes32"},{"name":"provider_address","type":"address"}],"name":"endSynapseSubscription_Subscriber","outputs":[],"payable":false,"type":"function"},{"constant":false,"inputs":[{"name":"group","type":"bytes32"},{"name":"provider_address","type":"address"},{"name":"public_key","type":"bytes32"},{"name":"encrypted_uuid","type":"bytes32"},{"name":"nonce","type":"bytes32"},{"name":"payment","type":"uint256"}],"name":"initSynapseDataFeed","outputs":[],"payable":false,"type":"function"},{"constant":true,"inputs":[{"name":"group","type":"bytes32"},{"name":"index","type":"uint256"}],"name":"getProviderPublic","outputs":[{"name":"","type":"bytes32"}],"payable":false,"type":"function"},{"constant":false,"inputs":[{"name":"group","type":"bytes32"},{"name":"subscriber_address","type":"address"}],"name":"endSynapseSubscription_Provider","outputs":[],"payable":false,"type":"function"},{"constant":false,"inputs":[{"name":"group","type":"bytes32"},{"name":"public_key","type":"bytes32"},{"name":"wei_rate","type":"uint256"}],"name":"registerSynapseProvider","outputs":[],"payable":false,"type":"function"},{"constant":true,"inputs":[{"name":"group","type":"bytes32"}],"name":"getProviderCount","outputs":[{"name":"","type":"uint256"}],"payable":false,"type":"function"},{"constant":true,"inputs":[{"name":"group","type":"bytes32"},{"name":"index","type":"uint256"}],"name":"getProviderRating","outputs":[{"name":"","type":"int256"}],"payable":false,"type":"function"},{"inputs":[{"name":"token","type":"address"}],"payable":false,"type":"constructor"},{"anonymous":false,"inputs":[{"indexed":false,"name":"index","type":"uint256"}],"name":"SynapseProviderFound","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"provider","type":"address"},{"indexed":false,"name":"subscriber","type":"address"},{"indexed":false,"name":"public_key","type":"bytes32"},{"indexed":false,"name":"amount","type":"uint256"},{"indexed":false,"name":"encrypted_uuid","type":"bytes32"},{"indexed":false,"name":"nonce","type":"bytes32"}],"name":"SynapseDataPurchase","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"provider","type":"address"},{"indexed":false,"name":"subsriber","type":"address"},{"indexed":false,"name":"terminator","type":"uint8"}],"name":"SynapseDataSubscriptionEnd","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"sender","type":"address"}],"name":"TransferFailed","type":"event"}];
...
class SynapseSubscriber {
    ...
    checkForRegister(configFile, callback) {
        ...
        if (false){//(localStorage.subscriberData) {
            //const data = JSON.parse(localStorage.subscriberData);

            this.private_key = data.private_key;

            // Generate a secp224k1 keypair
            //this.keypair = crypto.createECDH('secp224k1');
            this.keypair = crypto.createECDH('p224');
      ...
      //console.log(crypto.getCurves());
        ...
        /*
        localStorage.subscriberData = JSON.stringify({
    ...
    newSubscriptionWithIndex(provider_index, group, amount, callback) {
        ...
        this.marketInstance.methods.getProviderAddress(group, provider_index).call().then(providers_address => {
            this.marketInstance.methods.getProviderPublic(group, provider_index).call().then(providers_public => {
                ...
                if (provider_public_hex.length != (29 * 2)) {
		...
		const secret = sha256(secret_raw);
                ...
                const euuid = Buffer.concat([cipher.update(uuid),cipher.final()]);
                ...
                // Hexify the euuid
                const euuid_hex = "0x" + euuid.toString('hex');
...
setTimeout(() => {
    subscriber.newSubscriptionWithIndex(0, "danny_01", 10, (err, data) => {
