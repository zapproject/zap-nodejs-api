...
/// @title Dev Token Contract.
contract DevToken is ERC20, SafeMath, Ownable {

    string public constant name = "Dev Token";
    string public constant symbol = "DEV";
    string public constant version = 'v1';

    /// total amount of tokens
    uint256 public constant decimals = 10**8;
    uint256 public constant totalSupply = 10**6 * decimals; 
