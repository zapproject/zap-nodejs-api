...
/*
contract Client6 {
        function __zapCallback(uint256 id, string _response1, string _response2, string _response3, string _response4,string _response5, string _response6);
}
contract Client7 {
        function __zapCallback(uint256 id, string _response1, string _response2, string _response3, string _response4,string _response5, string _response6, string _response7);
}
contract Client8 {
        function __zapCallback(uint256 id, string _response1, string _response2, string _response3, string _response4,string _response5, string _response6, string _response7, string _response8);
}
*/
contract ZapDataProxyDispatch {
   ...
   function respond5(uint256 id, string _response1, string _response2, string _response3, string _response4) external returns (bool) {
        if (queries[id].provider != msg.sender || !fulfillQuery(id))
           revert();
        Client5(queries[id].subscriber).__zapCallback(id, _response1, _response2, _response3, _response4);
    }
/*
    function respond6(uint256 id, string _response1, string _response2, string _response3, string _response4, string _response5, string _response6) external returns (bool) {
        if (queries[id].provider != msg.sender || !fulfillQuery(id))
           revert();
        Client6(queries[id].subscriber).__tinyOracleCallback(id, _response1, _response2, _response3, _response4, _response5, _response6);
    }
  function respond7(uint256 id, string _response1, string _response2, string _response3, string _response4, string _response5, string _response6, string _reponse7) external returns (bool) {
        if (queries[id].provider != msg.sender || !fulfillQuery(id))
            revert();
        Client7(queries[id].subscriber).__tinyOracleCallback(id, _response1, _response2, _response3, _response4, _response5, _response6,_response7);
    }
    function respond8(uint256 id, string _response1, string _response2, string _response3, string _response4, string _response5, string _response6, string _response7, string _response8) external returns (bool) {
        if (queries[id].provider != msg.sender || !fulfillQuery(id))
             revert();
        Client8(queries[id].subscriber).__tinyOracleCallback(id, _response1, _response2, _response3, _response4, _response5, _response6,_response7,_response8);
     }
  */
